...
# The ET data contains negative values. ET is not negative. It is a good idea to talk to the tower maintainer or consult metadata to check the source of negative values:
...
![Fool Creek delineated watershed](fool_studyarea.png)
